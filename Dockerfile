...
RUN set -eu; \
    ...
    case "$(apk --print-arch)" in \
      x86_64) zig_arch=x86_64; sha256=02aa270f183da276e5b5920b1dac44a63f1a49e55050ebde3aecc9eb82f93239 ;; \
      aarch64) zig_arch=aarch64; sha256=958ed7d1e00d0ea76590d27666efbf7a932281b3d7ba0c6b01b0ff26498f667f ;; \
      *) echo "unsupported Docker architecture: $(apk --print-arch)" >&2; exit 1 ;; \
    esac; \
